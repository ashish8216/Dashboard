...
@endif
 ...
 <div class="card-header">
  ...
  @endif
<form  class="form-horizontal" action="{{ route('banners.update', $setting->id) }}" method="post" enctype="multipart/form-data" ><!-- form-horizontal Starts -->
@method('PATCH') 
   @csrf
<div class="card-body">
...
<div class="form-group row" ><!-- 1 form-group Starts -->
<label class="col-sm-2 col-form-label" > {{ __('Suber Title') }}</label>

<div class="col-sm-10" >
    
<input type="text" name="suber_title" class="form-control" value="{{ $setting->suber_title }}"/>
