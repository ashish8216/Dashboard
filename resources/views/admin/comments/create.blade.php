...
<form  class="form-horizontal" action="{{ route('blogs.store') }}" method="post" enctype="multipart/form-data" ><!-- form-horizontal Starts -->
@csrf
<div class="card-body">
...
<div class="col-sm-8" >
    <span class="input-group-btn">
          ...
          <input id="thumbnail" class="form-control" type="text" name="image_blgs" value="{{old('image_blgs')}}">
...
<!-- 4 form-group Starts --><!-- 4 form-group Starts -->
<!--<div class="form-group row" ><!-- 4 form-group Starts -->
