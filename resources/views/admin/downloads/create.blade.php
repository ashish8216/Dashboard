...
@endif
 ...
 <div class="card-header">
            <h3 class="card-title">{{ __('Download')}}</h3>

          </div>
<form  class="form-horizontal" action="{{ route('downloads.store') }}" method="post" enctype="multipart/form-data" ><!-- form-horizontal Starts -->
@csrf
<div class="card-body">
...
<div class="form-group row" ><!-- 1 form-group Starts -->
<label class="col-sm-4 col-form-label" > {{ __('Download')}}</label>
