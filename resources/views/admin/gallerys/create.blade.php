...
@endif
 ...
 <div class="card-header">
            <h3 class="card-title">{{ __('Gallery')}}</h3>

          </div>
<form  class="form-horizontal" action="{{ route('gallerys.store') }}" method="post" enctype="multipart/form-data" ><!-- form-horizontal Starts -->
@csrf
<div class="card-body">
