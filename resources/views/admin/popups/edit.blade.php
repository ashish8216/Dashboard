   ...
   <!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Popup</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<form  class="form-horizontal" action="{{ route('popups.update', $photo->id) }}" method="post" enctype="multipart/form-data" ><!-- form-horizontal Starts -->
...
<span class="input-group-btn">
          ...
          <input id="thumbnail" class="form-control" type="text" name="image" value="{{$photo->image}}">
...
<label class="col-sm-2 col-form-label" > {{ __('show/hide')}}</label>
