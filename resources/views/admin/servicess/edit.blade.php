...
<form class="form-horizontal" action="{{ route('servicess.update', $services->id) }}" method="post" enctype="multipart/form-data" ><!-- form-horizontal Starts -->
@method('PATCH') 
   @csrf
<div class="card-body">
...
<span class="input-group-btn">
          ...
          <input id="thumbnail" class="form-control" type="text" name="image" value="{{$services->image}}">
          <div id="holder" style="margin-top:15px;max-height:100px;"></div>
          @error('photo')
          <span class="text-danger">{{$message}}</span>
          @enderror
<br>
<img src="{{$services->image}}" style="height:100px" />
</div>
