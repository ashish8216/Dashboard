...
<form  class="form-horizontal" action="{{ route('teachers.update', $blog->id) }}" method="post" enctype="multipart/form-data" ><!-- form-horizontal Starts -->
@method('PATCH') 
   @csrf
<div class="card-body">
...
<div class="col-sm-8" >
<input type="text" name="post" class="form-control" value="{{$blog->post}}">
...
<div class="col-sm-8" >
<input type="email" name="email" class="form-control" value="{{$blog->email}}">
...
<div class="col-sm-8" >
<input type="text" name="mobile_number" class="form-control" value="{{$blog->mobile_number}}">
...
<div class="col-sm-8" >
<input type="url" name="facebook" class="form-control" value="{{$blog->facebook}}">
...
<div class="col-sm-8" >
<input type="url" name="twitter" class="form-control" value="{{$blog->twitter}}">
...
<div class="col-sm-8" >
<input type="url" name="skype" class="form-control" value="{{$blog->skype}}">
